  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="z-10 flex flex-col gap-2 group">
          <h3 className="text-lg font-semibold transition-all duration-300 ease-in-out text-primary group-hover:text-highlight">
            {project.title}
